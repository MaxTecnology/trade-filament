...
class SubcategoriasRelationManager extends RelationManager
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('SubcategoriasRelationManager')
                    ->required()
                    ->maxLength(255),
            ]);
    }
    ...
    {
        return $table
            ->recordTitleAttribute('SubcategoriasRelationManager')
            ->columns([
                Tables\Columns\TextColumn::make('SubcategoriasRelationManager'),
            ])
            ->filters([
                //
            ])
