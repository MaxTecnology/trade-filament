...
class OfertasRelationManager extends RelationManager
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('OfertasRelationManager')
                    ->required()
                    ->maxLength(255),
            ]);
    }
    ...
    {
        return $table
            ->recordTitleAttribute('OfertasRelationManager')
            ->columns([
                Tables\Columns\TextColumn::make('OfertasRelationManager'),
            ])
            ->filters([
                //
            ])
